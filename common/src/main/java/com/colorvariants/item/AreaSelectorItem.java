...
public class AreaSelectorItem extends Item {
    ...
    private void openAreaGUI(Level world, Player player, BlockPos first, BlockPos second) {
        Minecraft.getInstance().setScreen(new AreaColorPickerScreen(first, second));
    }
